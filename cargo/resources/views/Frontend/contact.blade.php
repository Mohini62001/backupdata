...
@push ('title')
 <title>Contact</title>
 @endpush
<div class="cs-subheader left" style="background:url({{url('Frontend/assets/extra-images/bg-subheader-01.jpg')}}) no-repeat 0 0 /cover; min-height:296px; padding:90px 0 0; margin-bottom:50px;">
    	<div class="container">
										...
										<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
											...
											<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
												<div class="cs-form-holder">
													<div class="input-holder"><input type="text" placeholder="Full Name" name="name"><i class=" icon-user"></i></div>
												</div>
											</div>
											<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
												<div class="cs-form-holder">
													<div class="input-holder"><input type="text" placeholder="Email Address" name="email"><i class=" icon-envelope"></i></div>
												</div>
											</div>
											<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
												<div class="cs-form-holder">
													<div class="input-holder"><input type="text" placeholder="Phone Number" name="phone"><i class="icon-mobile2"></i></div>
												</div>
											</div>
										...
										<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">	
											...
											<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
												<div class="cs-form-holder">
													...
													<textarea placeholder="Your Message" name="description"></textarea><i></i></div>
												</div>
											</div>
											<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
