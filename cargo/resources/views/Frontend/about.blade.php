...
@push ('title')
 ...
 @endpush
<div class="cs-subheader center" style="background:url({{url('Frontend/assets/extra-images/bg-subheader.jpg')}}) no-repeat 0 0 /cover; min-height:296px; padding:90px 0 0; margin-bottom:70px;">
		<div class="container">
	...
	<div class="main-section">
				...
				<div class="row">
					<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
						<div class="cs-column-text">
							...
							<a href="contact" class="btn-contact cs-color csborder-color">Contact us</a> </div>
					</div>
					<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
			...
			<div class="container">
				<div class="row">
					...
					<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
						<div class="cs-team">
							<div class="cs-media">
								<figure><a href="#"><img src="{{url('Frontend/assets/extra-images/team-img-1.jpg')}}" alt="" /></a></figure>
					...
					<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
						<div class="cs-team">
							<div class="cs-media">
								<figure><a href="#"><img src="{{url('Frontend/assets/extra-images/team-img-2.jpg')}}" alt="" /></a></figure>
								<div class="cs-caption"> <i class="icon-bars cs-top-icon"></i>
									<ul>
										<li><a href="#"><i class="icon-facebook2"></i></a></li>
										<li><a href="#"><i class="icon-twitter2"></i></a></li>
					...
					<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
						<div class="cs-team">
							<div class="cs-media">
								<figure><a href="#"><img src="{{url('Frontend/assets/extra-images/team-img-3.jpg')}}" alt="" /></a></figure>
								<div class="cs-caption"> <i class="icon-bars cs-top-icon"></i>
									<ul>
										<li><a href="#"><i class="icon-facebook2"></i></a></li>
										<li><a href="#"><i class="icon-twitter2"></i></a></li>
					...
					<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
						<div class="cs-team">
							<div class="cs-media">
								<figure><a href="#"><img src="{{url('Frontend/assets/extra-images/team-img-4.jpg')}}" alt="" /></a></figure>
								<div class="cs-caption"> <i class="icon-bars cs-top-icon"></i>
									<ul>
										<li><a href="#"><i class="icon-facebook2"></i></a></li>
										<li><a href="#"><i class="icon-twitter2"></i></a></li>
		...
		<div class="page-section" style=" background:url({{url('Frontend/assets/extra-images/bg-counter.jpg')}}) no-repeat 0 0 / cover; margin-bottom:50px; margin-top:20px;">
			<div class="container">
				<div class="row">
					<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
				...
				<div class="row">
					...
					<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
						<div class="cs-gallery">
							<div class="cs-media">
								<figure><a href="{{url('Frontend/assets/extra-images/gallery-img-1.jpg')}}" class="thumbnail"><img src="{{url('Frontend/assets/extra-images/gallery-img-1.jpg')}}" alt="" /></a>
					...
					<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
						<div class="cs-gallery">
							<div class="cs-media">
								<figure><a href="{{url('Frontend/assets/extra-images/gallery-img-2.jpg')}}" class="thumbnail"><img src="{{url('Frontend/assets/extra-images/gallery-img-2.jpg')}}" alt="" /></a>
									<figcaption><i class="icon-search2"></i><span>People will get clean water</span></figcaption>
								</figure>
							</div>
						</div>
					...
					<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
						<div class="cs-gallery">
							<div class="cs-media">
								<figure><a href="{{url('Frontend/assets/extra-images/gallery-img-3.jpg')}}" class="thumbnail"><img src="{{url('Frontend/assets/extra-images/gallery-img-3.jpg')}}" alt="" /></a>
									<figcaption><i class="icon-search2"></i><span>People will get clean water</span></figcaption>
								</figure>
							</div>
						</div>
					...
					<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
						<div class="cs-gallery">
							<div class="cs-media">
								<figure><a href="{{url('Frontend/assets/extra-images/gallery-img-4.jpg')}}" class="thumbnail"><img src="{{url('Frontend/assets/extra-images/gallery-img-4.jpg')}}" alt="" /></a>
									<figcaption><i class="icon-search2"></i><span>People will get clean water</span></figcaption>
								</figure>
							</div>
						</div>
					...
					<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
						<div class="cs-gallery">
							<div class="cs-media">
								<figure><a href="{{url('Frontend/assets/extra-images/gallery-img-5.jpg')}}" class="thumbnail"><img src="{{url('Frontend/assets/extra-images/gallery-img-5.jpg')}}" alt="" /></a>
									<figcaption><i class="icon-search2"></i><span>People will get clean water</span></figcaption>
								</figure>
							</div>
						</div>
					...
					<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
						<div class="cs-gallery">
							<div class="cs-media">
								<figure><a href="{{url('Frontend/assets/extra-images/gallery-img-6.jpg')}}" class="thumbnail"><img src="{{url('Frontend/assets/extra-images/gallery-img-6.jpg')}}" alt="" /></a>
									<figcaption><i class="icon-search2"></i><span>People will get clean water</span></figcaption>
								</figure>
							</div>
						</div>
					...
					<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
						<div class="cs-gallery">
							<div class="cs-media">
								<figure><a href="{{url('Frontend/assets/extra-images/gallery-img-7.jpg')}}" class="thumbnail"><img src="{{url('Frontend/assets/extra-images/gallery-img-7.jpg')}}" alt="" /></a>
									<figcaption><i class="icon-search2"></i><span>People will get clean water</span></figcaption>
								</figure>
							</div>
						</div>
					...
					<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
						<div class="cs-gallery">
							<div class="cs-media">
								<figure><a href="{{url('Frontend/assets/extra-images/gallery-img-8.jpg')}}" class="thumbnail"><img src="{{url('Frontend/assets/extra-images/gallery-img-8.jpg')}}" alt="" /></a>
									<figcaption><i class="icon-search2"></i><span>People will get clean water</span></figcaption>
								</figure>
							</div>
						</div>
