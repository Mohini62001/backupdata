...
@section('remaining_content')
 ...
 @endpush
	...
	<div class="main-section"> 
		<!--Main Banner-->
		<div class="page-section" style="background: url({{url('Frontend/assets/extra-images/full-section-img.jpg')}})no-repeat; background-size:cover; padding:206px 0 80px; text-shadow: 3px 4px 6px rgba(0,0,0,.37);margin-top:-30px;">
			<div class="container">
				<div class="row">
					<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
						<div class="image-frame defualt" style="padding-top:40px;">
							<div class="cs-media">
								<figure> <img src="{{url('Frontend/assets/extra-images/image-frame-1.png')}}" alt=""/> </figure>
							</div>
						</div>
					</div>
					<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
				...
				<div class="row">
					<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
						<div class="image-frame defualt">
							<div class="cs-media">
								<figure> <img src="{{url('Frontend/assets/extra-images/image-frame.jpg')}}" alt=""/> </figure>
							</div>
						</div>
					</div>
					<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
		...
		<div class="page-section" style="background:#edf0f5 url({{url('Frontend/assets/extra-images/full-width-img-01.png')}}) no-repeat; padding:100px 0 0 0;">
			<div class="container">
				<div class="row">
					<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
							...
							<div class="cs-blog cs-blog-grid">
								...
								<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
									<div class="cs-blog-listing blog-grid">
										<div class="cs-media">
											<figure> <a href="#"><img src="{{url('Frontend/assets/extra-images/blog-listing-1.jpg')}}" alt="" /></a>
												<figcaption>
										...
										<div class="blog-text">
											...
											<div class="post-meta">
												<figure><img src="{{url('Frontend/assets/extra-images/blog-grid-1.jpg')}}" alt="" /></figure>
								...
								<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
									<div class="cs-blog-listing blog-grid">
										<div class="cs-media">
											<figure> <a href="#"><img src="{{url('Frontend/assets/extra-images/blog-listing-2.jpg')}}" alt="" /></a>
										...
										<div class="blog-text">
											...
											<div class="post-meta">
												<figure><img src="{{url('Frontend/assets/extra-images/blog-grid-2.jpg')}}" alt="" /></figure>
								...
								<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
									<div class="cs-blog-listing blog-grid">
										<div class="cs-media">
											<figure> <a href="#"><img src="{{url('Frontend/assets/extra-images/blog-listing-3.jpg')}}" alt="" /></a>
												<figcaption></figcaption>
											</figure>
										</div>
										<div class="blog-text">
											...
											<div class="post-meta">
												<figure><img src="{{url('Frontend/assets/extra-images/blog-grid-3.jpg')}}" alt="" /></figure>
				...
				<div class="row">
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
						<div class="cs-ad" style="text-align:center; padding:55px 0 25px;">
							<div class="cs-media">
								<figure> <a href="#"><img alt="" src="{{url('Frontend/assets/extra-images/cs-ad-img.jpg')}}"></a> </figure>
							</div>
						</div>
					</div>
				</div>
