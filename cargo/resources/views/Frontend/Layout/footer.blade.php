...
<script src="{{url('Frontend/assets/scripts/responsive.menu.js')}}"></script> 
<script src="{{url('Frontend/assets/scripts/chosen.select.js')}}"></script> 
<script src="{{url('Frontend/assets/scripts/slick.js')}}"></script> 
<script src="{{url('Frontend/assets/scripts/echo.js')}}"></script> 
<!-- Put all Functions in functions.js')}} --> 
<script src="{{url('Frontend/assets/scripts/functions.js')}}"></script>
</body>
