						...
						<div class="table-responsive">
							<table class="table table-striped custom-table">
								...
								<tbody>
									<tr>
										<td>APT0001</td>
										<td><img width="28" height="28" src="{{url('Backend/Admin/assets/img/user.jpg')}}" class="rounded-circle m-r-5" alt=""> Denise Stevens</td>
										<td>35</td>
										<td>Henry Daniels</td>
										<td>Cardiology</td>
										<td>30 Dec 2018</td>
				...
				<div class="modal-dialog modal-dialog-centered">
					<div class="modal-content">
						<div class="modal-body text-center">
							<img src="{{url('Backend/Admin/assets/img/sent.png')}}" alt="" width="50" height="46">
