            ...
            <div class="sidebar-inner slimscroll">
                <div id="sidebar-menu" class="sidebar-menu">
                    <ul>
                        ...
                        <li class="submenu">
                            <a href="#"><i class="fa fa-cog"></i> <span> Cartype</span> <span class="menu-arrow"></span></a>
                            <ul style="display: none;">
							<li><a href="addcartype"></i> <span>Add Cartype</span></a></li>
						    <li><a href="managecartype"></i> <span>Manage Cartype</span></a></li>
							</ul>
                        </li>
					    ...
					    <li class="submenu">
                            <a href="#"><i class="fa fa-cog"></i> <span> Car Advertisement</span> <span class="menu-arrow"></span></a>
                            <ul style="display: none;">
							<li><a href="addcaradv"></i> <span>Add Caradv</span></a></li>
						    <li><a href="managecaradv"></i> <span>Manage CarAdv</span></a></li>
							</ul>
                        </li>

                        <li>
                            <a href="managebooking"><i class="fa fa-cog"></i> <span>Manage Booking</span></a>
                        </li>
						
						<li>
                            <a href="managecustomer"><i class="fa fa-cog"></i> <span>Manage Customer</span></a>
                        </li>
						
						<li>
                            <a href="managecontact"><i class="fa fa-cog"></i> <span>Manage Contact</span></a>
                        </li>
