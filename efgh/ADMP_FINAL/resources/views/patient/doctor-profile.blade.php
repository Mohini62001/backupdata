						...
						<div class="card-body">
							<div class="doctor-widget">
								...
								<div class="doc-info-right">
									...
									@if($fetch->hospital_status=='Not Available')
										<div class="clinic-booking">
											<a class="apt-btn" href="#">Doctor Not Available</a>
										</div>
									@else
										<div class="clinic-booking">
											...
											<div class="col-md-4">
												...
												<div class="clini-infos">
													<ul>
														...
														<li><i class="far fa-money-bill-alt"></i> Consulting Fees: <?php echo $fetch->consulting_fees?></li>
														<li><i class="far fa-money-bill-alt"></i> Followup Fees: <?php echo $fetch->followup_fees?></li><br>
														<li><i class="far fa-hospital"></i> Medical Store: <?php echo $fetch->medical_store?></li>
													</ul>
												</div>
												</div>
											</div>
