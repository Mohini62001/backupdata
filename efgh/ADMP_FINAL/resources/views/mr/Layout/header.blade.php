        ...
        <div class="main-wrapper">
            ...
            <div class="header">
                ...
                <div class="header-left">
                    <a href="{{url('/mr')}}" class="logo">
						<img src="{{url('/Backend/assets/img/logo.png')}}" alt="Logo">
					</a>
					<a href="{{url('/mr')}}" class="logo logo-small">
                ...
                <div class="sidebar-inner slimscroll">
					<div id="sidebar-menu" class="sidebar-menu">
						<ul>
							...
							<li> 
								<a href="{{url('/mr-myappointment')}}"><i class="fe fe-calendar"></i> <span>My Appointments</span></a>
							</li>
							...
							<li class="submenu">
								...
								<ul style="display: none;">
									<li>
											<a href="{{url('/mr-doctor')}}"><i class="fe fe-user"></i> <span>View Doctors</span></a>
									</li>
									<li>
