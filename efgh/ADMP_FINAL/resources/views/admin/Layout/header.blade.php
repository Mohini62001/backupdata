						...
						<ul>
							...
							<li class="submenu">
								...
								<ul style="display: none;">
									...
									<li>
											<a href="{{url('/admin-patient-appointment')}}"><i class="fe fe-user"></i> <span>Appointment</span></a>
									</li>
							...
							<li class="submenu">
								...
								<ul style="display: none;">
									...
									<li>
											<a href="{{url('/admin-company-appointment')}}"><i class="fe fe-user"></i> <span>Appointment</span></a>
									</li>
							...
							<li class="submenu">
								<a href="javascript:void(0);"><i class="fe fe-user"></i> <span>Manager</span> <span class="menu-arrow"></span></a>
								<ul style="display: none;">
									<li>
									...
									<li>
											<a href="{{url('/admin-manager-appointment')}}"><i class="fe fe-user"></i> <span>Appointment</span></a>
									</li>
							...
							<li class="submenu">
								...
								<ul style="display: none;">
									...
									<li>
											<a href="{{url('/admin-mr-appointment')}}"><i class="fe fe-user"></i> <span>Appointment</span></a>
									</li>
