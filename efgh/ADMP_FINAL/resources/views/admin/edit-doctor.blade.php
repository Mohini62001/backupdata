										...
										<div class="row">
											...
											<div class="col-xl-6">
												<div class="form-group row">
														...
														<?php
															$visit_pharma_per=$fetch->visit_pharma_per;
															if($visit_pharma_per=="1-1")
																{
														?>
																<option >Select Schedule</option>
																<option value="1-1"selected>Once in a Month</option>
														...
														<?php
															$visit_pharma_per=$fetch->visit_pharma_per;
															if($visit_pharma_per=="1-2")
																{
														?>
																<option >Select Schedule</option>
																<option value="1-1">Once in a Month</option>
																<option value="1-2"selected>Twice in a Month</option>
																<option value="1-3">Thrice in a Month</option>
																<option value="2-1">Once Visit in a 2 Month</option>
																<option value="3-1">Once Visit in a 3 Month</option>
														<?php
														...
														<?php
															$visit_pharma_per=$fetch->visit_pharma_per;
															if($visit_pharma_per=="1-3")
																{
														?>
																<option >Select Schedule</option>
																<option value="1-1">Once in a Month</option>
																<option value="1-2">Twice in a Month</option>
																<option value="1-3" selected>Thrice in a Month</option>
																<option value="2-1">Once Visit in a 2 Month</option>
																<option value="3-1">Once Visit in a 3 Month</option>
														<?php
																}
														...
														?>
																...
																<option value="1-2">Twice in a Month</option>
																<option value="1-3" >Thrice in a Month</option>
																<option value="2-1" selected>Once Visit in a 2 Month</option>
																<option value="3-1">Once Visit in a 3 Month</option>
														<?php
																}
...
<?php
														...
														?>
																...
																<option value="1-3" >Thrice in a Month</option>
																<option value="2-1" >Once Visit in a 2 Month</option>
																<option value="3-1" selected>Once Visit in a 3 Month</option>
														<?php
																}
