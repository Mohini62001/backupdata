                ...
                <div class="content container-fluid">
					...
					<div class="row">
						<div class="col-xl-4 d-flex">
							...
							<h4 class="card-title" style="padding-left:20px;padding-top:5px;">Add State</h4>
						...
						<div class="col-xl-4 d-flex">
							<div class="card flex-fill">
							<h4 class="card-title" style="padding-left:20px;padding-top:5px;">Add City</h4>
						...
						<div class="col-xl-4 d-flex">
							<div class="card flex-fill">
							<h4 class="card-title" style="padding-left:20px;padding-top:5px;">Add Area</h4>
