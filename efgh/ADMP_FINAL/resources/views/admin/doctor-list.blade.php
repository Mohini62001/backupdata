											   ...
											   @foreach($doctor_arr as $data)
												...
												<td class="text-right">
														<div class="actions">
															...
															<a class="btn btn-sm bg-success-light"  href="{{url('doctor_status/'.$data->id)}}">
																<i class="fe fe-pencil"></i> <?php echo $data->doctor_status?>
															</a>

															<a class="btn btn-sm bg-danger-light"  href="{{url('admin-add-doctor/'.$data->id)}}">
