                	...
                	<div class="loginbox">
                        ...
                        <div class="login-right">
							<div class="login-right-wrap">
								...
								<!---/Form -->
								<div class="text-center dont-have"><a href="{{url('/manager-register')}}">Don’t have an account? </a></div>
								<div class="text-center forgotpass"><a href="{{url('/mforgot_password')}}">Forgot Password?</a></div>
