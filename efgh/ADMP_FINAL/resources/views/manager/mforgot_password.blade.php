                	...
                	<div class="loginbox">
                        ...
                        <div class="login-right">
							<div class="login-right-wrap">
								<h1>Manager Forgot Password?</h1>
								<p class="account-subtitle">Enter your email to get a password reset otp</p>
								
								<!-- Form -->
								<form action="{{url('mforgot_password')}}" method="post" enctype="multipart/form-data">
									@csrf
								...
								<div class="text-center dont-have">Remember your password? <a href="{{url('/manager')}}">Login</a></div>
							</div>
                        </div>
                    </div>
                </div>
