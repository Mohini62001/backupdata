        ...
        <div class="main-wrapper">
            ...
            <div class="header">
                ...
                <div class="header-left">
					...
					<a href="{{url('/manager')}}" class="logo logo-small">
                ...
                <div class="sidebar-inner slimscroll">
					<div id="sidebar-menu" class="sidebar-menu">
						<ul>
							...
							<li class="active"> 
								<a href="{{url('/manager-dashboard')}}"><i class="fe fe-home"></i> <span>Dashboard</span></a>
							</li>
							<li> 
								<a href="{{url('/manager-myappointment')}}"><i class="fe fe-calendar"></i> <span>My Appointments</span></a>
							</li>
							...
							<li class="submenu">
								...
								<ul style="display: none;">
									<li>
											<a href="{{url('/manager-doctor')}}"><i class="fe fe-user"></i> <span>View Doctors</span></a>
									</li>
									<li>
							...
							<li class="submenu">
								...
								<ul style="display: none;">
									...
									<li>
											<a href="{{url('/manager-mr-appointment')}}"><i class="fe fe-user"></i> <span>Appointments</span></a>
									</li>
