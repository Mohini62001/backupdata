        ...
        <div class="main-wrapper">
            ...
            <div class="header">
                ...
                <div class="header-left">
					...
					<a href="{{url('/company')}}" class="logo logo-small">
                ...
                <div class="sidebar-inner slimscroll">
					<div id="sidebar-menu" class="sidebar-menu">
						<ul>
							...
							<li class="active"> 
								<a href="{{url('/company-dashboard')}}"><i class="fe fe-home"></i> <span>Dashboard</span></a>
							</li>
							...
							<li class="submenu">
								...
								<ul style="display: none;">
									<li>
											<a href="{{url('/company-doctor')}}"><i class="fe fe-user"></i> <span>View Doctors</span></a>
									</li>
									<li>
							...
							<li class="submenu">
								...
								<ul style="display: none;">
									...
									<li>
											<a href="{{url('/company-manager-appointment')}}"><i class="fe fe-user-plus"></i> <span>Appointment</span></a>
									</li>
							...
							<li class="submenu">
								...
								<ul style="display: none;">
									...
									<li>
											<a href="{{url('/company-mr-appointment')}}"><i class="fe fe-user"></i> <span>Appointment</span></a>
									</li>
