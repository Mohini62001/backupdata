                	...
                	<div class="loginbox">
                        ...
                        <div class="login-right">
							<div class="login-right-wrap">
								...
								<!-- Form -->
								<form action="{{url('cforgot_password')}}" method="post" enctype="multipart/form-data">
									@csrf
								...
								<div class="text-center dont-have">Remember your password? <a href="{{url('/company')}}">Login</a></div>
							</div>
                        </div>
                    </div>
                </div>
