...
@endpush
    ...
    <!-- about-banner -->
    <section class="about-banner" style="background-image: url({{url('Frontend/images/background/about-banner.jpg')}});">
        <div class="container">
                ...
                <div class="upper-content">
                    <div class="row">
                        <div class="col-lg-8 col-md-12 col-sm-12 image-column">
                            <figure class="image-box"><img src="{{url('Frontend/images/resource/about-4.jpg')}}" alt=""></figure>
                        </div>
                        <div class="col-lg-4 col-md-12 col-sm-12 content-column">
                            <div class="content-box wow fadeInRight" data-wow-delay="300ms" data-wow-duration="1500ms">
                                ...
                                <p>Since over 36 years we produce machines and plants with dedicated software, robotic automation The iconic Building 680 is the famous Mare Island Naval Shipyard machine shop where determined Americans rebuilt the Pacific Fleet after the attack on Pearl Harbor</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-lg-5 col-md-12 col-sm-12 left-column">
                            <div class="content-box wow fadeInLeft" data-wow-delay="300ms" data-wow-duration="1500ms">
                                ...
                                <p>Our homes are Union Made. We are committed to progressive labor practices and built on a strong relationship with the Northern California Carpenters Regional Council We have a unique agreement with the union to recruit and train local workers</p>
                            </div>
                        </div>
                        <div class="col-lg-7 col-md-12 col-sm-12 right-column">
                            <div class="content-box">
                                ...
                                <div class="text">
                                    <p>ince over 36 years we produce machines and plants with dedicated software, robotic automation The iconic Building 680 is the famous Mare Island Naval Shipyard machine shop where determined Americans rebuilt the Pacific Fleet </p>
                                    <p>Acto is an industry leader with more than 44,000 employees in 1,000 locations in over 100 countries We deliver Total Quality Assurance expertise 24 hours a day, 7 days a week with our industry-winning processes and customer-centric culture.</p>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <!-- statistics-section -->
    <section class="statistics-section" style="background-image: url({{url('Frontend/images/background/statistics-bg.jpg')}});">
        <div class="container">
                ...
                <div class="row">
                    <div class="col-xl-7 col-lg-12 col-md-12 offset-xl-5 inner-column">
                        <div class="inner-box wow fadeInRight" data-wow-delay="300ms" data-wow-duration="1500ms">
                            ...
                            <div class="top-box">
                                <h2>Statistics</h2>
                                <div class="text">Global energy statistics at your fingertips. Explore the most reliable and in-depth energy data available in the world.</div>
        ...
        <div class="container">
            ...
            <div class="four-item-carousel owl-carousel owl-theme">
                <div class="team-block-two">
                    <div class="inner-box">
                        <figure class="image-box"><a href="#"><img src="{{url('Frontend/images/resource/team-4.jpg')}}" alt=""></a></figure>
                        <div class="lower-content">
                ...
                <div class="team-block-two">
                    <div class="inner-box">
                        <figure class="image-box"><a href="#"><img src="{{url('Frontend/images/resource/team-5.jpg')}}" alt=""></a></figure>
                        <div class="lower-content">
                ...
                <div class="team-block-two">
                    <div class="inner-box">
                        <figure class="image-box"><a href="#"><img src="{{url('Frontend/images/resource/team-6.jpg')}}" alt=""></a></figure>
                        <div class="lower-content">
                ...
                <div class="team-block-two">
                    <div class="inner-box">
                        <figure class="image-box"><a href="#"><img src="{{url('Frontend/images/resource/team-7.jpg')}}" alt=""></a></figure>
                        <div class="lower-content">
        ...
        <div class="container">
            ...
            <div class="three-column-carousel owl-carousel owl-theme">
                <div class="testimonial-content">
                    <div class="inner-box">
                        <div class="author-info">
                            <figure class="author-thumb"><img src="{{url('Frontend/images/resource/testimonial-3.png')}}" alt=""></figure>
                            <h5>Tamim Anj</h5>
                ...
                <div class="testimonial-content">
                    <div class="inner-box">
                        <div class="author-info">
                            <figure class="author-thumb"><img src="{{url('Frontend/images/resource/testimonial-4.png')}}" alt=""></figure>
                            <h5>Anjek Mac</h5>
                ...
                <div class="testimonial-content">
                    <div class="inner-box">
                        <div class="author-info">
                            <figure class="author-thumb"><img src="{{url('Frontend/images/resource/testimonial-5.png')}}" alt=""></figure>
                            <h5>Tom Cruse</h5>
    ...
    <section class="subscribe-section about-page bg-color-3">
        <div class="container">
            <div class="inner-box">
                <figure class="icon-box"><img src="{{url('Frontend/images/icons/paper-plane.png')}}" alt=""></figure>
                <div class="content-box">
