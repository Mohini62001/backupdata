                        ...
                        <ul class="metismenu " id="sidebarNav">
                            ...
                            <li>
                                ...
                                <ul aria-expanded="false">
                                    <li> <a href="auth-login">Add Category</a> </li>
                                    <li> <a href="auth-register">Manage Category</a> </li>
                                </ul>
                            </li>
                            <li>
                                ...
                                <ul aria-expanded="false">
                                    <li> <a href="auth-login">Add Product</a> </li>
                                    <li> <a href="auth-register">Manage Product</a> </li>
                                </ul>
                            </li>
