...
@section('main_container')
  ...
  <section class="banner-section bg_img" data-background="{{url('Frontend/assets/images/banner.jpg')}}">
    <div class="container">
      <div class="row align-items-center">
        ...
        <div class="col-md-5">
          <div class="banner-img">
            <img src="{{url('Frontend/assets/images/elements/banner-man.png')}}" alt="image">
          </div>
        </div>
      </div>
    </div>
  ...
  <section class="rent-step-section pb-120">
    <div class="element-one"><img src="{{url('Frontend/assets/images/elements/car.png')}}" alt="image"></div>
    <div class="container">
      <div class="row">
        <div class="col-lg-6">
      ...
      <div class="row">
        <div class="col-lg-12">
          <div class="choose-car-slider owl-carousel">
            <div class="car-item">
              <div class="thumb">
                <img src="{{url('Frontend/assets/images/cars/1.jpg')}}" alt="image">
              </div>
            ...
            <div class="car-item">
              <div class="thumb">
                <img src="{{url('Frontend/assets/images/cars/2.jpg')}}" alt="image">
              </div>
              <div class="car-item-body">
                <div class="content">
            ...
            <div class="car-item">
              <div class="thumb">
                <img src="{{url('Frontend/assets/images/cars/3.jpg')}}" alt="image">
              </div>
              <div class="car-item-body">
                <div class="content">
      ...
      <div class="row">
        ...
        <div class="col-lg-6">
          <div class="overview-img">
            <div class="img-container"><img src="{{url('Frontend/assets/images/overview/2.jpg')}}" alt="image"></div>
            <div class="img-container"><img src="{{url('Frontend/assets/images/overview/1.jpg')}}" alt="image"></div>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="container">
      ...
      <div class="row mb-none-30">
        <div class="col-lg-4 col-sm-6">
          <div class="team-item">
            <div class="thumb">
              <img src="{{url('Frontend/assets/images/team/1.jpg')}}" alt="image">
              <div class="content">
        ...
        <div class="col-lg-4 col-sm-6">
          <div class="team-item">
            <div class="thumb">
              <img src="{{url('Frontend/assets/images/team/2.jpg')}}" alt="image">
              <div class="content">
                <h3 class="name">William cook</h3>
                <span class="designation">Support Manager</span>
                <ul class="social-list d-flex justify-content-center">
        ...
        <div class="col-lg-4 col-sm-6">
          <div class="team-item">
            <div class="thumb">
              <img src="{{url('Frontend/assets/images/team/3.jpg')}}" alt="image">
              <div class="content">
                <h3 class="name">William cook</h3>
                <span class="designation">Support Manager</span>
                <ul class="social-list d-flex justify-content-center">
  ...
  <section class="testimonial-section overlay-black pt-120 pb-120 bg_img" data-background="{{url('Frontend/assets/images/testimonial-bg.jpg')}}">
    <div class="container">
      <div class="row justify-content-center">
        <div class="col-lg-8">
      ...
      <div class="row mb-none-30">
        <div class="col-lg-6">  
          <div class="post-item post-item--grid">
            <div class="thumb bg_img" data-background="{{url('Frontend/assets/images/blog/1.jpg')}}">
        ...
        <div class="col-lg-6">  
          <div class="post-item post-item--grid">
            <div class="thumb bg_img" data-background="{{url('Frontend/assets/images/blog/2.jpg')}}">
              <ul class="post-meta d-flex">
                <li><a href="#0">25 Jan 2019</a></li>
                <li><a href="#0">03 Comments</a></li>
              </ul>
        ...
        <div class="col-lg-6">  
          <div class="post-item post-item--grid">
            <div class="thumb bg_img" data-background="{{url('Frontend/assets/images/blog/3.jpg')}}">
              <ul class="post-meta d-flex">
                <li><a href="#0">25 Jan 2019</a></li>
                <li><a href="#0">03 Comments</a></li>
              </ul>
        ...
        <div class="col-lg-6">  
          <div class="post-item post-item--grid">
            <div class="thumb bg_img" data-background="{{url('Frontend/assets/images/blog/4.jpg')}}">
              <ul class="post-meta d-flex">
                <li><a href="#0">25 Jan 2019</a></li>
                <li><a href="#0">03 Comments</a></li>
              </ul>
