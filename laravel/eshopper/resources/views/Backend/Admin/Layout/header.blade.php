                ...
                <div id="sidebar-menu" class="sidebar-menu">
                    <ul>
                        ...
                        <li class="submenu">
						    ...
						    <li><a href="managecategory"></i> <span>Manage Category</span></a></li>
							</ul>
                        </li>
					    ...
					    <li class="submenu">
                            <a href="#"><i class="fa fa-cog"></i> <span> Cloth Advertisement</span> <span class="menu-arrow"></span></a>
                            <ul style="display: none;">
							<li><a href="addcloth"></i> <span>Add Cloth</span></a></li>
						    <li><a href="managecloth"></i> <span>Manage Cloth</span></a></li>
							</ul>
                        </li>
