...
<link href="{{url('Frontend/css/magnific-popup.css')}}" rel="stylesheet" type="text/css">
		<script>
			...
			<div class="row">
				<div class="col-md-3">
					<div class="menu_box">
					   ...
					   <div class="banner_img"><img src="{{url('Frontend/images/pic9.jpg')}}" class="img-responsive" alt=""/></div>
			  ...
			  <div class="content_grid">
				  <div class="col_1_of_3 span_1_of_3 simpleCart_shelfItem"> 
				  	   <a href="single.html">
						   <div class="inner_content clearfix">
							<div class="product_image">
								<img src="{{url('Frontend/images/pic4.jpg')}}" class="img-responsive" alt=""/>
								<a href="" class="button item_add item_1"> </a>	
								<div class="product_container">
								   <div class="cart-left">
									 <p class="title">Lorem Ipsum 2015</p>
				    ...
				    <div class="col_1_of_3 span_1_of_3 simpleCart_shelfItem"> 
						   ...
						   <div class="inner_content clearfix">
							<div class="product_image">
								<img src="{{url('Frontend/images/pic5.jpg')}}" class="img-responsive" alt=""/>
								<a href="" class="button item_add item_1"> </a>	
								<div class="product_container">
								   <div class="cart-left">
									 <p class="title">Lorem Ipsum 2015</p>
				    ...
				    <div class="col_1_of_3 span_1_of_3 simpleCart_shelfItem last_1"> 
						   ...
						   <div class="inner_content clearfix">
							<div class="product_image">
								<img src="{{url('Frontend/images/pic6.jpg')}}" class="img-responsive" alt=""/>
								<a href="" class="button item_add item_1"> </a>	
								<div class="product_container">
								   <div class="cart-left">
									 <p class="title">Lorem Ipsum 2015</p>
			   ...
			   <div class="content_grid">
			   		<div class="col_1_of_3 span_1_of_3 simpleCart_shelfItem"> 
				  	   <a href="single.html">
						   <div class="inner_content clearfix">
							<div class="product_image">
								<img src="{{url('Frontend/images/pic7.jpg')}}" class="img-responsive" alt=""/>
								<a href="" class="button item_add item_1"> </a>		
							    <div class="product_container">
								   <div class="cart-left">
									 <p class="title">Lorem Ipsum 2015</p>
				    ...
				    <div class="col_1_of_3 span_1_of_3 simpleCart_shelfItem"> 
						   ...
						   <div class="inner_content clearfix">
							<div class="product_image">
								<img src="{{url('Frontend/images/pic8.jpg')}}" class="img-responsive" alt=""/>
								<a href="" class="button item_add item_1"> </a>		
							    <div class="product_container">
								   <div class="cart-left">
									 <p class="title">Lorem Ipsum 2015</p>
				    ...
				    <div class="col_1_of_3 span_1_of_3 simpleCart_shelfItem last_1"> 
				  	  <a href="single.html">
						   <div class="inner_content clearfix">
							<div class="product_image">
								<img src="{{url('Frontend/images/pic13.jpg')}}" class="img-responsive" alt=""/>
								<a href="" class="button item_add item_1"> </a>	
								 <div class="product_container">
								   <div class="cart-left">
									 <p class="title">Lorem Ipsum 2015</p>
			   ...
			   <div class="content_grid">
			   		<div class="col_1_of_3 span_1_of_3 simpleCart_shelfItem"> 
				  	   <a href="single.html">
						   <div class="inner_content clearfix">
							<div class="product_image">
								<img src="{{url('Frontend/images/pic10.jpg')}}" class="img-responsive" alt=""/>
								<a href="" class="button item_add item_1"> </a>		
								<div class="product_container">
								   <div class="cart-left">
									 <p class="title">Lorem Ipsum 2015</p>
				    ...
				    <div class="col_1_of_3 span_1_of_3 simpleCart_shelfItem"> 
				  	   <a href="single.html">
						   <div class="inner_content clearfix">
							<div class="product_image">
								<img src="{{url('Frontend/images/pic11.jpg')}}" class="img-responsive" alt=""/>
								<a href="" class="button item_add item_1"> </a>	
								<div class="product_container">
								   <div class="cart-left">
									 <p class="title">Lorem Ipsum 2015</p>
				    ...
				    <div class="col_1_of_3 span_1_of_3 simpleCart_shelfItem last_1"> 
				  	    <a href="single.html">
						   <div class="inner_content clearfix">
							<div class="product_image">
								<img src="{{url('Frontend/images/pic12.jpg')}}" class="img-responsive" alt=""/>
								<a href="" class="button item_add item_1"> </a>	
								<div class="product_container">
								   <div class="cart-left">
									 <p class="title">Lorem Ipsum 2015</p>
		...
		<div class="container">
		  <div class="brands">
			 <ul class="brand_icons">
				<li><img src='{{url('Frontend/images/icon1.jpg')}}' class="img-responsive" alt=""/></li>
				<li><img src='{{url('Frontend/images/icon2.jpg')}}' class="img-responsive" alt=""/></li>
				<li><img src='{{url('Frontend/images/icon3.jpg')}}' class="img-responsive" alt=""/></li>
				<li><img src='{{url('Frontend/images/icon4.jpg')}}' class="img-responsive" alt=""/></li>
				<li><img src='{{url('Frontend/images/icon5.jpg')}}' class="img-responsive" alt=""/></li>
				<li><img src='{{url('Frontend/images/icon6.jpg')}}' class="img-responsive" alt=""/></li>
				<li class="last"><img src='{{url('Frontend/images/icon7.jpg')}}' class="img-responsive" alt=""/></li>
			 </ul>
		   </div>
	    </div>
	    <div class="container">
	      <div class="instagram_top">
	        ...
	        <ul class="instagram_grid">
			  <li><a class="popup-with-zoom-anim" href="#small-dialog1"><img src="{{url('Frontend/images/i1.jpg')}}" class="img-responsive"alt=""/></a></li>
			  <li><a class="popup-with-zoom-anim" href="#small-dialog1"><img src="{{url('Frontend/images/i2.jpg')}}" class="img-responsive" alt=""/></a></li>
			  <li><a class="popup-with-zoom-anim" href="#small-dialog1"><img src="{{url('Frontend/images/i3.jpg')}}" class="img-responsive" alt=""/></a></li>
			  <li><a class="popup-with-zoom-anim" href="#small-dialog1"><img src="{{url('Frontend/images/i4.jpg')}}" class="img-responsive" alt=""/></a></li>
			  <li><a class="popup-with-zoom-anim" href="#small-dialog1"><img src="{{url('Frontend/images/i5.jpg')}}" class="img-responsive" alt=""/></a></li>
			  <li class="last_instagram"><a class="popup-with-zoom-anim" href="#small-dialog1"><img src="{{url('Frontend/images/i6.jpg')}}" class="img-responsive" alt=""/></a></li>
			  <div class="clearfix"></div>
			  <div id="small-dialog1" class="mfp-hide">
				<div class="pop_up">
					<h4>A Sample Photo Stream</h4>
					<img src="{{url('Frontend/images/i_zoom.jpg')}}" class="img-responsive" alt=""/>
				</div>
			  </div>
			</ul>
		  </div>
			...
			<div class="container">
				...
				<div class="footer-grid">
				  ...
				  <div class="footer-grid">
			        ...
			        <img src="{{url('Frontend/images/payment.png')}}" class="img-responsive" alt=""/>
				 </div>
